...
public class GUI_Login extends javax.swing.JFrame {
  ...
  private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
    ...
    if (tfUsername.getText().isBlank() == false) {
      username = tfUsername.getText();
    }
    
    if (tfPassword.getText().isBlank() == false) {
    ...
    try {
      ...
      if (isAuthenticated) {
        JOptionPane.showMessageDialog(this, "LOGIN BERHASIL. Selamat Datang " + login.nama + " !");
      }
    } catch(Exception a) {
      System.out.println(a.getMessage());
      JOptionPane.showMessageDialog(this, "Login Gagal. Username/Password tidak boleh kosong");
    }
