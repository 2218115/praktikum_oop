...
public class GUI_BarangMikroElektronik extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    tblInformasiBarang.setModel(new javax.swing.table.DefaultTableModel(
      ...
      new String [] {
        "Kode Barang", "Kategori Barang", "Pemasok", "Pabrikan", "Nama", "Jumlah", "Datasheet", "Teg. Kerja"
      }
    ));
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        String datasheet = tfInput1.getText();
        double tegKerja = Double.parseDouble(tfInput2.getText());
        ...
        BarangMikroElektronik inputBarang = new BarangMikroElektronik(datasheet, tegKerja, kategoriBarangTerpilih, pemasok, pabrikan, nama, jumlah);
        ...
        clearTable();
        DefaultTableModel tableModel = (DefaultTableModel)tblInformasiBarang.getModel();
        for (BarangMikroElektronik b : barangs) {
  ...
  private void tfSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfSearchKeyReleased
    ...
    List<BarangMikroElektronik> filteredBarangs = new ArrayList<BarangMikroElektronik>();
    ...
    DefaultTableModel tableModel = (DefaultTableModel)tblInformasiBarang.getModel();
    clearTable();
    for (BarangMikroElektronik b : filteredBarangs) {
      tableModel.addRow(b.getFields());
    } 
