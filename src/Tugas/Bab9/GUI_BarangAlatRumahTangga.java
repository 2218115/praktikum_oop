...
public class GUI_BarangAlatRumahTangga extends javax.swing.JFrame {
    ...
    public GUI_BarangAlatRumahTangga() {
        ...
        view.initRT();
        view.showBarangInTable(model.findByCategory("Peralatan Rumah Tangga"));
    }
  ...
  private void initComponents() {
    ...
    label2.setText("Input Barang (AlatRumahTangga)");
  ...
  private void tfSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfSearchKeyReleased
    List<Barang> filteredBarangs = model.findByNameAndCategory(view.getSearchQuery(), "Peralatan Rumah Tangga");
