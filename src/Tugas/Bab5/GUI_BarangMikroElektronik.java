...
public class GUI_BarangMikroElektronik extends javax.swing.JFrame {
    ...
    public GUI_BarangMikroElektronik() {
        ...
        cbKategoriBarang.setSelectedIndex(1);
    }
  ...
  private void initComponents() {
    ...
    tfDokDatasheet = new javax.swing.JTextField();
    tfTeganganKerja = new javax.swing.JTextField();
    ...
    cbKategoriBarang.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
      public void propertyChange(java.beans.PropertyChangeEvent evt) {
        cbKategoriBarangPropertyChange(evt);
      }
    });
    ...
    label2.setText("Input Barang (Mikro Elektronik)");

    lbInput1.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
    lbInput1.setText("DokumenDatasheet");

    lbInput2.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
    lbInput2.setText("TeganganKerja");

    tfDokDatasheet.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N

    tfTeganganKerja.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                      ...
                      .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                          ...
                          .addComponent(tfDokDatasheet)
                          .addComponent(tfTeganganKerja))))
                    .addGap(74, 74, 74)))
        ...
        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
          .addGroup(layout.createSequentialGroup()
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
              .addComponent(lbInput1)
              .addComponent(tfDokDatasheet, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
            .addGap(27, 27, 27)
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
              .addComponent(lbInput2)
              .addComponent(tfTeganganKerja, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    // variabel list dengan tipe barang mikroelektronik
    // penyimpan kumpulan barang
    List<BarangMikroElektronik> barangs = new ArrayList<BarangMikroElektronik>();
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        String dokumenDatasheet = tfDokDatasheet.getText();
        double tegKerja = Double.parseDouble(tfTeganganKerja.getText());
        
        // generate fake KodeBarang
        String fakeKodeBarang = generateKodeBarang(nama);
        
        // buat objek BarangMikroElektronik
        BarangMikroElektronik inputBarangMikroelektronik = new BarangMikroElektronik(dokumenDatasheet, tegKerja,  kategoriBarangTerpilih, pemasok, pabrikan, nama, jumlah);
         
        // set nilai kodeBarang menggunakan setter
        inputBarangMikroelektronik.setKodeBarang(fakeKodeBarang);
        ...
        barangs.add(inputBarangMikroelektronik);
        ...
        taDisplayBarang.append("Kode       : " + inputBarangMikroelektronik.getKodeBarang() + "\n");
        taDisplayBarang.append("Kategori   : " + inputBarangMikroelektronik.getKategori() + "\n");
        taDisplayBarang.append("Pemasok    : " + inputBarangMikroelektronik.getPemasok() + "\n");
        taDisplayBarang.append("Pabrikan   : " + inputBarangMikroelektronik.getPabrikan() + "\n");
        taDisplayBarang.append("Nama       : " + inputBarangMikroelektronik.getNama() + "\n");
        taDisplayBarang.append("Jumlah     : " + inputBarangMikroelektronik.getJumlah() + "\n");
        taDisplayBarang.append("Datasheet  : " + inputBarangMikroelektronik.getDokumenDatasheet()+ "\n");
        taDisplayBarang.append("Teg. Kerja : " + inputBarangMikroelektronik.getTeganganKerja()+ "\n\n");
        ...
        for (int indexBarang = 0;indexBarang < barangs.size();++indexBarang) {
            BarangMikroElektronik barang = barangs.get(indexBarang);
            ...
            taDisplayBarang.append("   Datasheet   : " + barang.getDokumenDatasheet()+ "\n");
            taDisplayBarang.append("   Teg. Kerja  : " + barang.getTeganganKerja()+ "\n\n");
  ...
  private void cbKategoriBarangPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_cbKategoriBarangPropertyChange
    // TODO add your handling code here:
  }//GEN-LAST:event_cbKategoriBarangPropertyChange
