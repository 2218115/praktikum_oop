...
public class Gui_Penilaian extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    private void tabel_dataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabel_dataMouseClicked
        ...
        np1 = tabel_data.getValueAt(tabel, 2).toString();
        np2 = tabel_data.getValueAt(tabel, 3).toString();
        UTS = tabel_data.getValueAt(tabel, 4).toString();
        np3 = tabel_data.getValueAt(tabel, 5).toString();
        PRAK = tabel_data.getValueAt(tabel, 6).toString();
        UAS = tabel_data.getValueAt(tabel, 7).toString();
        NA = tabel_data.getValueAt(tabel, 8).toString();
        itempilih();
